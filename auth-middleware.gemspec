...
Gem::Specification.new do |spec|
  ...
  spec.description   = %q{Middleware to easily add QS ID authentifaction to web apps}
  spec.summary       = %q{Middleware to easily add QS ID authentifaction to web apps}
  spec.homepage      = ""
  spec.license       = "MIT"
